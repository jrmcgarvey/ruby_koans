...
class Proxy
  ...
  #  puts "method name is " + method_name.to_s
  ...
  def respond_to?(method_name) # not too good, doesn't include the methods in this proxy
  ...
  def number_of_times_called(method_name)
    if !@times_called.has_key?(method_name)
      return 0
    end
